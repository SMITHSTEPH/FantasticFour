...
public class SensorGraph2 {
	...
	public static void main(String[] args) {
		...
		SerialPort leftUSBPort = SerialPort.getCommPort("/dev/cu.usbserial"); //specific port on our local machine
	...
	connectButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				if (connectButton.getText().equals("Connect")) {
					...
					final String recipientNumber= phoneNumberTextField.getText(); //gets phone number in cell phone field
							...
							try{
								...
								if(internet == true){
									try {
										//SENDING AS BYTES
										//String zero ="0";
										//output.write(zero.getBytes()); //send signal to arduino that machine is ready
									...
									try {
										//SENDING AS BYTES
										//String three= "3";
										//output.write(three.getBytes()); //send signal to arduino that machine is NOT ready (No Internet)
										...
										virtualButton.addMouseListener(new MouseListener(){
											public void mousePressed(java.awt.event.MouseEvent e) {
												...
												try {
													...
													//SENDING AS BYTES
													//String one= "1";
													//output.write(one.getBytes()); //send 1 to arduino for: push third box button 
 ...
 */
	public static void sendTextMessage(int temperature, int textCount, String recipientNumber) {
		String recipient= "+" + recipientNumber; //appends plus sign to number (needed for API)
		int maxTextCount=15;
