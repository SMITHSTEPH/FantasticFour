...
//pins
const short LEDPins[] = {4,5,6,7,8,9, 10}; //need to have 7 LEDs
...
//testing
//SoftwareSerial testPort(11, 12); //for testing
const int testLED=4;
short t=0;
...
{ 
  ...
  if(temperature == DEVICE_DISCONNECTED){unpluggedSensor=true;}
  if(pc)
  { 
